[![Test](https://github.com/check-spelling-sandbox/refactored-octo-train/actions/workflows/test.yml/badge.svg)](https://github.com/check-spelling-sandbox/refactored-octo-train/actions/workflows/test.yml)
...
```yaml
- uses: check-spelling-sandbox/refactored-octo-train@main
  with:
